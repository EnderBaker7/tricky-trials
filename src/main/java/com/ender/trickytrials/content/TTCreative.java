    ...
    public static final RegistryObject<CreativeModeTab> TRICKY_TAB = CREATIVE_TABS.register("creative_tab",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(TTItems.WAXED_COPPER_DOOR.get());
                        ...
                        output.accept(TTItems.WAXED_COPPER_TRAPDOOR.get());
                        ...
                        output.accept(TTItems.POLISHED_TUFF.get());
                        ...
                        output.accept(TTItems.CHISELED_TUFF.get());
                        output.accept(TTItems.CHISELED_TUFF_BRICKS.get());
                    })
                    .build());
